...
private:
  ...
  static std::vector<std::string> build_interface_preference_list()
  {
    ...
    result.emplace_back("rl0");
    result.emplace_back("wi0");
    result.emplace_back("en0");
    result.emplace_back("enp2s0");
    result.emplace_back("enp3s0");
    result.emplace_back("en1");
    result.emplace_back("en2");
    result.emplace_back("en3");
    result.emplace_back("eth0");
    result.emplace_back("eth1");
    result.emplace_back("eth2");
    result.emplace_back("em1");
    result.emplace_back("em0");
    result.emplace_back("ppp");
    result.emplace_back("ppp0");
    result.emplace_back("vmnet1");
    result.emplace_back("vmnet0");
    result.emplace_back("vmnet3");
    result.emplace_back("vmnet4");
    result.emplace_back("vmnet5");
    result.emplace_back("vmnet6");
    result.emplace_back("vmnet7");
    result.emplace_back("vmnet8");
    result.emplace_back("virbr0");
    result.emplace_back("wlan0");
    result.emplace_back("lo0");
    return result;
  }
