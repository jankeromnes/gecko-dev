...
void av1_convolve_2d_scale_c(const uint8_t *src, int src_stride, CONV_BUF_TYPE *dst, int dst_stride, int w, int h, InterpFilterParams *filter_params_x, InterpFilterParams *filter_params_y, const int subpel_x_qn, const int x_step_qn, const int subpel_y_qn, const int y_step_qn, ConvolveParams *conv_params);
...
void av1_convolve_horiz_c(const uint8_t *src, int src_stride, uint8_t *dst, int dst_stride, int w, int h, const InterpFilterParams filter_params, const int subpel_x_q4, int x_step_q4, ConvolveParams *conv_params);
void av1_convolve_horiz_ssse3(const uint8_t *src, int src_stride, uint8_t *dst, int dst_stride, int w, int h, const InterpFilterParams filter_params, const int subpel_x_q4, int x_step_q4, ConvolveParams *conv_params);
...
void av1_convolve_vert_c(const uint8_t *src, int src_stride, uint8_t *dst, int dst_stride, int w, int h, const InterpFilterParams filter_params, const int subpel_y_q4, int y_step_q4, ConvolveParams *conv_params);
void av1_convolve_vert_ssse3(const uint8_t *src, int src_stride, uint8_t *dst, int dst_stride, int w, int h, const InterpFilterParams filter_params, const int subpel_y_q4, int y_step_q4, ConvolveParams *conv_params);
...
void av1_fht16x16_c(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
void av1_fht16x16_sse2(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
void av1_fht16x16_avx2(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
RTCD_EXTERN void (*av1_fht16x16)(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *param);

void av1_fht16x32_c(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
void av1_fht16x32_sse2(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
#define av1_fht16x32 av1_fht16x32_sse2

void av1_fht16x4_c(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
#define av1_fht16x4 av1_fht16x4_c

void av1_fht16x8_c(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
void av1_fht16x8_sse2(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
#define av1_fht16x8 av1_fht16x8_sse2

void av1_fht32x16_c(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
void av1_fht32x16_sse2(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
#define av1_fht32x16 av1_fht32x16_sse2

void av1_fht32x32_c(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
void av1_fht32x32_sse2(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
void av1_fht32x32_avx2(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
RTCD_EXTERN void (*av1_fht32x32)(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *param);

void av1_fht32x8_c(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
#define av1_fht32x8 av1_fht32x8_c

void av1_fht4x16_c(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
#define av1_fht4x16 av1_fht4x16_c

void av1_fht4x4_c(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
void av1_fht4x4_sse2(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
#define av1_fht4x4 av1_fht4x4_sse2

void av1_fht4x8_c(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
void av1_fht4x8_sse2(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
#define av1_fht4x8 av1_fht4x8_sse2

void av1_fht8x16_c(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
void av1_fht8x16_sse2(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
#define av1_fht8x16 av1_fht8x16_sse2

void av1_fht8x32_c(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
#define av1_fht8x32 av1_fht8x32_c

void av1_fht8x4_c(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
void av1_fht8x4_sse2(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
#define av1_fht8x4 av1_fht8x4_sse2

void av1_fht8x8_c(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
void av1_fht8x8_sse2(const int16_t *input, tran_low_t *output, int stride, struct txfm_param *txfm_param);
...
void av1_fwd_txfm2d_16x16_sse4_1(const int16_t *input, int32_t *coeff, int stride, TX_TYPE tx_type, int bd);
...
void av1_fwd_txfm2d_4x4_sse4_1(const int16_t *input, int32_t *coeff, int input_stride, TX_TYPE tx_type, int bd);
...
void av1_fwd_txfm2d_8x8_sse4_1(const int16_t *input, int32_t *coeff, int stride, TX_TYPE tx_type, int bd);
...
void av1_highbd_convolve_2d_scale_c(const uint16_t *src, int src_stride, CONV_BUF_TYPE *dst, int dst_stride, int w, int h, InterpFilterParams *filter_params_x, InterpFilterParams *filter_params_y, const int subpel_x_qn, const int x_step_qn, const int subpel_y_qn, const int y_step_qn, ConvolveParams *conv_params, int bd);
...
void av1_highbd_convolve_horiz_c(const uint16_t *src, int src_stride, uint16_t *dst, int dst_stride, int w, int h, const InterpFilterParams filter_params, const int subpel_x_q4, int x_step_q4, int avg, int bd);
void av1_highbd_convolve_horiz_sse4_1(const uint16_t *src, int src_stride, uint16_t *dst, int dst_stride, int w, int h, const InterpFilterParams filter_params, const int subpel_x_q4, int x_step_q4, int avg, int bd);
...
void av1_highbd_convolve_rounding_c(const int32_t *src, int src_stride, uint8_t *dst8, int dst_stride, int w, int h, int bits, int bd);
void av1_highbd_convolve_rounding_avx2(const int32_t *src, int src_stride, uint8_t *dst8, int dst_stride, int w, int h, int bits, int bd);
...
void av1_highbd_convolve_vert_c(const uint16_t *src, int src_stride, uint16_t *dst, int dst_stride, int w, int h, const InterpFilterParams filter_params, const int subpel_y_q4, int y_step_q4, int avg, int bd);
void av1_highbd_convolve_vert_sse4_1(const uint16_t *src, int src_stride, uint16_t *dst, int dst_stride, int w, int h, const InterpFilterParams filter_params, const int subpel_y_q4, int y_step_q4, int avg, int bd);
...
void av1_highbd_quantize_fp_sse4_1(const tran_low_t *coeff_ptr, intptr_t count, int skip_block, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, tran_low_t *qcoeff_ptr, tran_low_t *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan, int log_scale);
...
void av1_highbd_temporal_filter_apply_c(uint8_t *frame1_8, unsigned int stride, uint8_t *frame2_8, unsigned int block_width, unsigned int block_height, int strength, int filter_weight, unsigned int *accumulator, uint16_t *count);
...
void av1_highpass_filter_c(uint8_t *dgd, int width, int height, int stride, int32_t *dst, int dst_stride, int corner, int edge);
void av1_highpass_filter_sse4_1(uint8_t *dgd, int width, int height, int stride, int32_t *dst, int dst_stride, int corner, int edge);
...
void av1_highpass_filter_highbd_c(uint16_t *dgd, int width, int height, int stride, int32_t *dst, int dst_stride, int corner, int edge);
void av1_highpass_filter_highbd_sse4_1(uint16_t *dgd, int width, int height, int stride, int32_t *dst, int dst_stride, int corner, int edge);
...
void av1_iht16x16_256_add_c(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
void av1_iht16x16_256_add_sse2(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
void av1_iht16x16_256_add_avx2(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
RTCD_EXTERN void (*av1_iht16x16_256_add)(const tran_low_t *input, uint8_t *output, int pitch, const struct txfm_param *param);

void av1_iht16x32_512_add_c(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
void av1_iht16x32_512_add_sse2(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
#define av1_iht16x32_512_add av1_iht16x32_512_add_sse2

void av1_iht16x4_64_add_c(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
#define av1_iht16x4_64_add av1_iht16x4_64_add_c

void av1_iht16x8_128_add_c(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
void av1_iht16x8_128_add_sse2(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
#define av1_iht16x8_128_add av1_iht16x8_128_add_sse2

void av1_iht32x16_512_add_c(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
void av1_iht32x16_512_add_sse2(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
#define av1_iht32x16_512_add av1_iht32x16_512_add_sse2

void av1_iht32x32_1024_add_c(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
#define av1_iht32x32_1024_add av1_iht32x32_1024_add_c

void av1_iht32x8_256_add_c(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
#define av1_iht32x8_256_add av1_iht32x8_256_add_c

void av1_iht4x16_64_add_c(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
#define av1_iht4x16_64_add av1_iht4x16_64_add_c

void av1_iht4x4_16_add_c(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
void av1_iht4x4_16_add_sse2(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
#define av1_iht4x4_16_add av1_iht4x4_16_add_sse2

void av1_iht4x8_32_add_c(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
void av1_iht4x8_32_add_sse2(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
#define av1_iht4x8_32_add av1_iht4x8_32_add_sse2

void av1_iht8x16_128_add_c(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
void av1_iht8x16_128_add_sse2(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
#define av1_iht8x16_128_add av1_iht8x16_128_add_sse2

void av1_iht8x32_256_add_c(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
#define av1_iht8x32_256_add av1_iht8x32_256_add_c

void av1_iht8x4_32_add_c(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
void av1_iht8x4_32_add_sse2(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
#define av1_iht8x4_32_add av1_iht8x4_32_add_sse2

void av1_iht8x8_64_add_c(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
void av1_iht8x8_64_add_sse2(const tran_low_t *input, uint8_t *dest, int stride, const struct txfm_param *txfm_param);
...
void av1_inv_txfm2d_add_16x16_sse4_1(const int32_t *coeff, uint16_t *output, int stride, TX_TYPE tx_type, int bd);
...
void av1_inv_txfm2d_add_32x32_avx2(const int32_t *coeff, uint16_t *output, int stride, TX_TYPE tx_type, int bd);
...
void av1_inv_txfm2d_add_4x4_sse4_1(const int32_t *coeff, uint16_t *output, int stride, TX_TYPE tx_type, int bd);
...
void av1_inv_txfm2d_add_8x8_sse4_1(const int32_t *coeff, uint16_t *output, int stride, TX_TYPE tx_type, int bd);
...
void av1_selfguided_restoration_sse4_1(uint8_t *dgd, int width, int height, int dgd_stride, int32_t *dst, int dst_stride, int r, int eps);
...
void av1_selfguided_restoration_highbd_sse4_1(uint16_t *dgd, int width, int height, int dgd_stride, int32_t *dst, int dst_stride, int bit_depth, int r, int eps);
