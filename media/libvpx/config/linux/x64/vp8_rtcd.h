...
void vp8_dequant_idct_add_uv_block_c(short *q, short *dq, unsigned char *dstu, unsigned char *dstv, int stride, char *eobs);
void vp8_dequant_idct_add_uv_block_sse2(short *q, short *dq, unsigned char *dstu, unsigned char *dstv, int stride, char *eobs);
...
void vp8_loop_filter_simple_horizontal_edge_c(unsigned char *s, int p, const unsigned char *blimit);
...
void vp8_loop_filter_simple_vertical_edge_c(unsigned char *s, int p, const unsigned char *blimit);
