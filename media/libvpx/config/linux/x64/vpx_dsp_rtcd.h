...
void vpx_convolve_avg_c(const uint8_t *src, ptrdiff_t src_stride, uint8_t *dst, ptrdiff_t dst_stride, const int16_t *filter_x, int filter_x_stride, const int16_t *filter_y, int filter_y_stride, int w, int h);
...
void vpx_convolve_copy_c(const uint8_t *src, ptrdiff_t src_stride, uint8_t *dst, ptrdiff_t dst_stride, const int16_t *filter_x, int filter_x_stride, const int16_t *filter_y, int filter_y_stride, int w, int h);
...
void vpx_d63f_predictor_4x4_c(uint8_t *dst, ptrdiff_t stride, const uint8_t *above, const uint8_t *left);
...
void vpx_get16x16var_c(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, unsigned int *sse, int *sum);
void vpx_get16x16var_sse2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse, int *sum);
void vpx_get16x16var_avx2(const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int recon_stride, unsigned int *SSE, int *Sum);
...
unsigned int vpx_get4x4sse_cs_c(const unsigned char *a, int a_stride, const unsigned char *b, int  b_stride);
#define vpx_get4x4sse_cs vpx_get4x4sse_cs_c

void vpx_get8x8var_c(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, unsigned int *sse, int *sum);
void vpx_get8x8var_sse2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse, int *sum);
...
void vpx_lpf_horizontal_16_sse2(uint8_t *s, int p, const uint8_t *_blimit, const uint8_t *_limit, const uint8_t *_thresh);
void vpx_lpf_horizontal_16_avx2(uint8_t *s, int p, const uint8_t *_blimit, const uint8_t *_limit, const uint8_t *_thresh);
...
void vpx_lpf_horizontal_16_dual_sse2(uint8_t *s, int p, const uint8_t *_blimit, const uint8_t *_limit, const uint8_t *_thresh);
void vpx_lpf_horizontal_16_dual_avx2(uint8_t *s, int p, const uint8_t *_blimit, const uint8_t *_limit, const uint8_t *_thresh);
...
void vpx_lpf_horizontal_4_c(uint8_t *s, int p, const uint8_t *blimit, const uint8_t *limit, const uint8_t *thresh);
void vpx_lpf_horizontal_4_sse2(uint8_t *s, int p, const uint8_t *_blimit, const uint8_t *_limit, const uint8_t *_thresh);
#define vpx_lpf_horizontal_4 vpx_lpf_horizontal_4_sse2

void vpx_lpf_horizontal_4_dual_c(uint8_t *s, int p, const uint8_t *blimit0, const uint8_t *limit0, const uint8_t *thresh0, const uint8_t *blimit1, const uint8_t *limit1, const uint8_t *thresh1);
void vpx_lpf_horizontal_4_dual_sse2(uint8_t *s, int p, const uint8_t *_blimit0, const uint8_t *_limit0, const uint8_t *_thresh0, const uint8_t *_blimit1, const uint8_t *_limit1, const uint8_t *_thresh1);
#define vpx_lpf_horizontal_4_dual vpx_lpf_horizontal_4_dual_sse2

void vpx_lpf_horizontal_8_c(uint8_t *s, int p, const uint8_t *blimit, const uint8_t *limit, const uint8_t *thresh);
void vpx_lpf_horizontal_8_sse2(uint8_t *s, int p, const uint8_t *_blimit, const uint8_t *_limit, const uint8_t *_thresh);
#define vpx_lpf_horizontal_8 vpx_lpf_horizontal_8_sse2

void vpx_lpf_horizontal_8_dual_c(uint8_t *s, int p, const uint8_t *blimit0, const uint8_t *limit0, const uint8_t *thresh0, const uint8_t *blimit1, const uint8_t *limit1, const uint8_t *thresh1);
void vpx_lpf_horizontal_8_dual_sse2(uint8_t *s, int p, const uint8_t *_blimit0, const uint8_t *_limit0, const uint8_t *_thresh0, const uint8_t *_blimit1, const uint8_t *_limit1, const uint8_t *_thresh1);
#define vpx_lpf_horizontal_8_dual vpx_lpf_horizontal_8_dual_sse2

void vpx_lpf_vertical_16_c(uint8_t *s, int p, const uint8_t *blimit, const uint8_t *limit, const uint8_t *thresh);
void vpx_lpf_vertical_16_sse2(uint8_t *s, int p, const uint8_t *blimit, const uint8_t *limit, const uint8_t *thresh);
#define vpx_lpf_vertical_16 vpx_lpf_vertical_16_sse2

void vpx_lpf_vertical_16_dual_c(uint8_t *s, int p, const uint8_t *blimit, const uint8_t *limit, const uint8_t *thresh);
void vpx_lpf_vertical_16_dual_sse2(uint8_t *s, int p, const uint8_t *blimit, const uint8_t *limit, const uint8_t *thresh);
...
void vpx_lpf_vertical_4_sse2(uint8_t *s, int p, const uint8_t *_blimit, const uint8_t *_limit, const uint8_t *_thresh);
...
void vpx_lpf_vertical_4_dual_sse2(uint8_t *s, int p, const uint8_t *blimit0, const uint8_t *limit0, const uint8_t *thresh0, const uint8_t *blimit1, const uint8_t *limit1, const uint8_t *thresh1);
...
void vpx_lpf_vertical_8_sse2(uint8_t *s, int p, const uint8_t *blimit, const uint8_t *limit, const uint8_t *thresh);
...
void vpx_lpf_vertical_8_dual_sse2(uint8_t *s, int p, const uint8_t *blimit0, const uint8_t *limit0, const uint8_t *thresh0, const uint8_t *blimit1, const uint8_t *limit1, const uint8_t *thresh1);
...
unsigned int vpx_mse16x16_c(const uint8_t *a, int  a_stride, const uint8_t *b, int  b_stride, unsigned int *sse);
unsigned int vpx_mse16x16_sse2(const uint8_t *src, int  src_stride, const uint8_t *ref, int  ref_stride, unsigned int *sse);
unsigned int vpx_mse16x16_avx2(const uint8_t *src, int  src_stride, const uint8_t *ref, int  ref_stride, unsigned int *sse);
...
unsigned int vpx_mse16x8_c(const uint8_t *a, int  a_stride, const uint8_t *b, int  b_stride, unsigned int *sse);
unsigned int vpx_mse16x8_sse2(const uint8_t *src, int  src_stride, const uint8_t *ref, int  ref_stride, unsigned int *sse);
#define vpx_mse16x8 vpx_mse16x8_sse2

unsigned int vpx_mse8x16_c(const uint8_t *a, int  a_stride, const uint8_t *b, int  b_stride, unsigned int *sse);
unsigned int vpx_mse8x16_sse2(const uint8_t *src, int  src_stride, const uint8_t *ref, int  ref_stride, unsigned int *sse);
#define vpx_mse8x16 vpx_mse8x16_sse2

unsigned int vpx_mse8x8_c(const uint8_t *a, int  a_stride, const uint8_t *b, int  b_stride, unsigned int *sse);
unsigned int vpx_mse8x8_sse2(const uint8_t *src, int  src_stride, const uint8_t *ref, int  ref_stride, unsigned int *sse);
...
unsigned int vpx_sad16x16_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride);
...
unsigned int vpx_sad16x16_avg_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, const uint8_t *second_pred);
...
void vpx_sad16x16x3_c(const uint8_t *src, int src_stride, const uint8_t *ref_array, int ref_stride, uint32_t *sad_array);
...
void vpx_sad16x16x4d_c(const uint8_t *src, int src_stride, const uint8_t * const ref_array[], int ref_stride, uint32_t *sad_array);
...
void vpx_sad16x16x8_c(const uint8_t *src, int src_stride, const uint8_t *ref_array, int ref_stride, uint32_t *sad_array);
...
unsigned int vpx_sad16x32_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride);
...
unsigned int vpx_sad16x32_avg_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, const uint8_t *second_pred);
...
void vpx_sad16x32x4d_c(const uint8_t *src, int src_stride, const uint8_t * const ref_array[], int ref_stride, uint32_t *sad_array);
...
unsigned int vpx_sad16x8_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride);
...
unsigned int vpx_sad16x8_avg_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, const uint8_t *second_pred);
...
void vpx_sad16x8x3_c(const uint8_t *src, int src_stride, const uint8_t *ref_array, int ref_stride, uint32_t *sad_array);
...
void vpx_sad16x8x4d_c(const uint8_t *src, int src_stride, const uint8_t * const ref_array[], int ref_stride, uint32_t *sad_array);
...
void vpx_sad16x8x8_c(const uint8_t *src, int src_stride, const uint8_t *ref_array, int ref_stride, uint32_t *sad_array);
...
unsigned int vpx_sad32x16_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride);
...
unsigned int vpx_sad32x16_avg_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, const uint8_t *second_pred);
...
void vpx_sad32x16x4d_c(const uint8_t *src, int src_stride, const uint8_t * const ref_array[], int ref_stride, uint32_t *sad_array);
...
unsigned int vpx_sad32x32_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride);
...
unsigned int vpx_sad32x32_avg_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, const uint8_t *second_pred);
...
void vpx_sad32x32x3_c(const uint8_t *src, int src_stride, const uint8_t *ref_array, int ref_stride, uint32_t *sad_array);
#define vpx_sad32x32x3 vpx_sad32x32x3_c

void vpx_sad32x32x4d_c(const uint8_t *src, int src_stride, const uint8_t * const ref_array[], int ref_stride, uint32_t *sad_array);
...
void vpx_sad32x32x4d_avx2(const uint8_t *src, int src_stride, const uint8_t * const ref[], int ref_stride, uint32_t *res);
...
void vpx_sad32x32x8_c(const uint8_t *src, int src_stride, const uint8_t *ref_array, int ref_stride, uint32_t *sad_array);
#define vpx_sad32x32x8 vpx_sad32x32x8_c

unsigned int vpx_sad32x64_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride);
...
unsigned int vpx_sad32x64_avg_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, const uint8_t *second_pred);
...
void vpx_sad32x64x4d_c(const uint8_t *src, int src_stride, const uint8_t * const ref_array[], int ref_stride, uint32_t *sad_array);
...
unsigned int vpx_sad4x4_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride);
...
unsigned int vpx_sad4x4_avg_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, const uint8_t *second_pred);
...
void vpx_sad4x4x3_c(const uint8_t *src, int src_stride, const uint8_t *ref_array, int ref_stride, uint32_t *sad_array);
...
void vpx_sad4x4x4d_c(const uint8_t *src, int src_stride, const uint8_t * const ref_array[], int ref_stride, uint32_t *sad_array);
...
void vpx_sad4x4x8_c(const uint8_t *src, int src_stride, const uint8_t *ref_array, int ref_stride, uint32_t *sad_array);
...
unsigned int vpx_sad4x8_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride);
...
unsigned int vpx_sad4x8_avg_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, const uint8_t *second_pred);
...
void vpx_sad4x8x4d_c(const uint8_t *src, int src_stride, const uint8_t * const ref_array[], int ref_stride, uint32_t *sad_array);
...
void vpx_sad4x8x8_c(const uint8_t *src, int src_stride, const uint8_t *ref_array, int ref_stride, uint32_t *sad_array);
#define vpx_sad4x8x8 vpx_sad4x8x8_c

unsigned int vpx_sad64x32_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride);
...
unsigned int vpx_sad64x32_avg_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, const uint8_t *second_pred);
...
void vpx_sad64x32x4d_c(const uint8_t *src, int src_stride, const uint8_t * const ref_array[], int ref_stride, uint32_t *sad_array);
...
unsigned int vpx_sad64x64_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride);
...
unsigned int vpx_sad64x64_avg_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, const uint8_t *second_pred);
...
void vpx_sad64x64x3_c(const uint8_t *src, int src_stride, const uint8_t *ref_array, int ref_stride, uint32_t *sad_array);
#define vpx_sad64x64x3 vpx_sad64x64x3_c

void vpx_sad64x64x4d_c(const uint8_t *src, int src_stride, const uint8_t * const ref_array[], int ref_stride, uint32_t *sad_array);
...
void vpx_sad64x64x4d_avx2(const uint8_t *src, int src_stride, const uint8_t * const ref[], int ref_stride, uint32_t *res);
...
void vpx_sad64x64x8_c(const uint8_t *src, int src_stride, const uint8_t *ref_array, int ref_stride, uint32_t *sad_array);
#define vpx_sad64x64x8 vpx_sad64x64x8_c

unsigned int vpx_sad8x16_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride);
...
unsigned int vpx_sad8x16_avg_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, const uint8_t *second_pred);
...
void vpx_sad8x16x3_c(const uint8_t *src, int src_stride, const uint8_t *ref_array, int ref_stride, uint32_t *sad_array);
...
void vpx_sad8x16x4d_c(const uint8_t *src, int src_stride, const uint8_t * const ref_array[], int ref_stride, uint32_t *sad_array);
...
void vpx_sad8x16x8_c(const uint8_t *src, int src_stride, const uint8_t *ref_array, int ref_stride, uint32_t *sad_array);
...
unsigned int vpx_sad8x4_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride);
...
unsigned int vpx_sad8x4_avg_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, const uint8_t *second_pred);
...
void vpx_sad8x4x4d_c(const uint8_t *src, int src_stride, const uint8_t * const ref_array[], int ref_stride, uint32_t *sad_array);
...
void vpx_sad8x4x8_c(const uint8_t *src, int src_stride, const uint8_t *ref_array, int ref_stride, uint32_t *sad_array);
#define vpx_sad8x4x8 vpx_sad8x4x8_c

unsigned int vpx_sad8x8_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride);
...
unsigned int vpx_sad8x8_avg_c(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, const uint8_t *second_pred);
...
void vpx_sad8x8x3_c(const uint8_t *src, int src_stride, const uint8_t *ref_array, int ref_stride, uint32_t *sad_array);
...
void vpx_sad8x8x4d_c(const uint8_t *src, int src_stride, const uint8_t * const ref_array[], int ref_stride, uint32_t *sad_array);
...
void vpx_sad8x8x8_c(const uint8_t *src, int src_stride, const uint8_t *ref_array, int ref_stride, uint32_t *sad_array);
...
uint32_t vpx_sub_pixel_avg_variance16x16_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse, const uint8_t *second_pred);
uint32_t vpx_sub_pixel_avg_variance16x16_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
uint32_t vpx_sub_pixel_avg_variance16x16_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
...
uint32_t vpx_sub_pixel_avg_variance16x32_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse, const uint8_t *second_pred);
uint32_t vpx_sub_pixel_avg_variance16x32_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
uint32_t vpx_sub_pixel_avg_variance16x32_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
...
uint32_t vpx_sub_pixel_avg_variance16x8_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse, const uint8_t *second_pred);
uint32_t vpx_sub_pixel_avg_variance16x8_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
uint32_t vpx_sub_pixel_avg_variance16x8_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
...
uint32_t vpx_sub_pixel_avg_variance32x16_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse, const uint8_t *second_pred);
uint32_t vpx_sub_pixel_avg_variance32x16_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
uint32_t vpx_sub_pixel_avg_variance32x16_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
...
uint32_t vpx_sub_pixel_avg_variance32x32_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse, const uint8_t *second_pred);
uint32_t vpx_sub_pixel_avg_variance32x32_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
uint32_t vpx_sub_pixel_avg_variance32x32_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
uint32_t vpx_sub_pixel_avg_variance32x32_avx2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse, const uint8_t *sec);
...
uint32_t vpx_sub_pixel_avg_variance32x64_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse, const uint8_t *second_pred);
uint32_t vpx_sub_pixel_avg_variance32x64_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
uint32_t vpx_sub_pixel_avg_variance32x64_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
...
uint32_t vpx_sub_pixel_avg_variance4x4_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse, const uint8_t *second_pred);
uint32_t vpx_sub_pixel_avg_variance4x4_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
uint32_t vpx_sub_pixel_avg_variance4x4_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
...
uint32_t vpx_sub_pixel_avg_variance4x8_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse, const uint8_t *second_pred);
uint32_t vpx_sub_pixel_avg_variance4x8_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
uint32_t vpx_sub_pixel_avg_variance4x8_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
...
uint32_t vpx_sub_pixel_avg_variance64x32_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse, const uint8_t *second_pred);
uint32_t vpx_sub_pixel_avg_variance64x32_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
uint32_t vpx_sub_pixel_avg_variance64x32_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
...
uint32_t vpx_sub_pixel_avg_variance64x64_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse, const uint8_t *second_pred);
uint32_t vpx_sub_pixel_avg_variance64x64_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
uint32_t vpx_sub_pixel_avg_variance64x64_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
uint32_t vpx_sub_pixel_avg_variance64x64_avx2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse, const uint8_t *sec);
...
uint32_t vpx_sub_pixel_avg_variance8x16_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse, const uint8_t *second_pred);
uint32_t vpx_sub_pixel_avg_variance8x16_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
uint32_t vpx_sub_pixel_avg_variance8x16_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
...
uint32_t vpx_sub_pixel_avg_variance8x4_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse, const uint8_t *second_pred);
uint32_t vpx_sub_pixel_avg_variance8x4_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
uint32_t vpx_sub_pixel_avg_variance8x4_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
...
uint32_t vpx_sub_pixel_avg_variance8x8_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse, const uint8_t *second_pred);
uint32_t vpx_sub_pixel_avg_variance8x8_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
uint32_t vpx_sub_pixel_avg_variance8x8_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sseptr, const uint8_t *sec);
...
uint32_t vpx_sub_pixel_variance16x16_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse);
uint32_t vpx_sub_pixel_variance16x16_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
uint32_t vpx_sub_pixel_variance16x16_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
...
uint32_t vpx_sub_pixel_variance16x32_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse);
uint32_t vpx_sub_pixel_variance16x32_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
uint32_t vpx_sub_pixel_variance16x32_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
...
uint32_t vpx_sub_pixel_variance16x8_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse);
uint32_t vpx_sub_pixel_variance16x8_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
uint32_t vpx_sub_pixel_variance16x8_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
...
uint32_t vpx_sub_pixel_variance32x16_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse);
uint32_t vpx_sub_pixel_variance32x16_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
uint32_t vpx_sub_pixel_variance32x16_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
...
uint32_t vpx_sub_pixel_variance32x32_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse);
uint32_t vpx_sub_pixel_variance32x32_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
uint32_t vpx_sub_pixel_variance32x32_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
uint32_t vpx_sub_pixel_variance32x32_avx2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse);
...
uint32_t vpx_sub_pixel_variance32x64_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse);
uint32_t vpx_sub_pixel_variance32x64_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
uint32_t vpx_sub_pixel_variance32x64_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
...
uint32_t vpx_sub_pixel_variance4x4_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse);
uint32_t vpx_sub_pixel_variance4x4_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
uint32_t vpx_sub_pixel_variance4x4_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
...
uint32_t vpx_sub_pixel_variance4x8_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse);
uint32_t vpx_sub_pixel_variance4x8_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
uint32_t vpx_sub_pixel_variance4x8_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
...
uint32_t vpx_sub_pixel_variance64x32_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse);
uint32_t vpx_sub_pixel_variance64x32_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
uint32_t vpx_sub_pixel_variance64x32_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
...
uint32_t vpx_sub_pixel_variance64x64_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse);
uint32_t vpx_sub_pixel_variance64x64_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
uint32_t vpx_sub_pixel_variance64x64_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
uint32_t vpx_sub_pixel_variance64x64_avx2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse);
...
uint32_t vpx_sub_pixel_variance8x16_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse);
uint32_t vpx_sub_pixel_variance8x16_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
uint32_t vpx_sub_pixel_variance8x16_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
...
uint32_t vpx_sub_pixel_variance8x4_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse);
uint32_t vpx_sub_pixel_variance8x4_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
uint32_t vpx_sub_pixel_variance8x4_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
...
uint32_t vpx_sub_pixel_variance8x8_c(const uint8_t *a, int a_stride, int xoffset, int  yoffset, const uint8_t *b, int b_stride, uint32_t *sse);
uint32_t vpx_sub_pixel_variance8x8_sse2(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
uint32_t vpx_sub_pixel_variance8x8_ssse3(const uint8_t *src, int src_stride, int x_offset, int  y_offset, const uint8_t *dst, int dst_stride, uint32_t *sse_ptr);
...
void vpx_subtract_block_c(int rows, int cols, int16_t *diff, ptrdiff_t diff_stride, const uint8_t *src, ptrdiff_t src_stride, const uint8_t *pred, ptrdiff_t pred_stride);
...
unsigned int vpx_variance16x16_c(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, unsigned int *sse);
unsigned int vpx_variance16x16_sse2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
unsigned int vpx_variance16x16_avx2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
...
unsigned int vpx_variance16x32_c(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, unsigned int *sse);
unsigned int vpx_variance16x32_sse2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
#define vpx_variance16x32 vpx_variance16x32_sse2

unsigned int vpx_variance16x8_c(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, unsigned int *sse);
unsigned int vpx_variance16x8_sse2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
#define vpx_variance16x8 vpx_variance16x8_sse2

unsigned int vpx_variance32x16_c(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, unsigned int *sse);
unsigned int vpx_variance32x16_sse2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
unsigned int vpx_variance32x16_avx2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
...
unsigned int vpx_variance32x32_c(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, unsigned int *sse);
unsigned int vpx_variance32x32_sse2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
unsigned int vpx_variance32x32_avx2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
...
unsigned int vpx_variance32x64_c(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, unsigned int *sse);
unsigned int vpx_variance32x64_sse2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
#define vpx_variance32x64 vpx_variance32x64_sse2

unsigned int vpx_variance4x4_c(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, unsigned int *sse);
unsigned int vpx_variance4x4_sse2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
#define vpx_variance4x4 vpx_variance4x4_sse2

unsigned int vpx_variance4x8_c(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, unsigned int *sse);
unsigned int vpx_variance4x8_sse2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
#define vpx_variance4x8 vpx_variance4x8_sse2

unsigned int vpx_variance64x32_c(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, unsigned int *sse);
unsigned int vpx_variance64x32_sse2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
unsigned int vpx_variance64x32_avx2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
...
unsigned int vpx_variance64x64_c(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, unsigned int *sse);
unsigned int vpx_variance64x64_sse2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
unsigned int vpx_variance64x64_avx2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
...
unsigned int vpx_variance8x16_c(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, unsigned int *sse);
unsigned int vpx_variance8x16_sse2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
#define vpx_variance8x16 vpx_variance8x16_sse2

unsigned int vpx_variance8x4_c(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, unsigned int *sse);
unsigned int vpx_variance8x4_sse2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
#define vpx_variance8x4 vpx_variance8x4_sse2

unsigned int vpx_variance8x8_c(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, unsigned int *sse);
unsigned int vpx_variance8x8_sse2(const uint8_t *src, int src_stride, const uint8_t *ref, int ref_stride, unsigned int *sse);
