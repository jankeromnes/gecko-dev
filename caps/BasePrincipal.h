...
public:
  ...
  NS_IMETHOD Equals(nsIPrincipal* aOther, bool* aResult) final;
  NS_IMETHOD EqualsConsideringDomain(nsIPrincipal* aOther, bool* aResult) final;
  NS_IMETHOD Subsumes(nsIPrincipal* aOther, bool* aResult) final;
  NS_IMETHOD SubsumesConsideringDomain(nsIPrincipal* aOther, bool* aResult) final;
  NS_IMETHOD SubsumesConsideringDomainIgnoringFPD(nsIPrincipal* aOther, bool* aResult) final;
  NS_IMETHOD CheckMayLoad(nsIURI* aURI, bool aReport, bool aAllowIfInheritsPrincipal) final;
  NS_IMETHOD GetAddonPolicy(nsISupports** aResult) final;
  NS_IMETHOD GetCsp(nsIContentSecurityPolicy** aCsp) override;
  NS_IMETHOD SetCsp(nsIContentSecurityPolicy* aCsp) override;
  NS_IMETHOD EnsureCSP(nsIDOMDocument* aDocument, nsIContentSecurityPolicy** aCSP) override;
  NS_IMETHOD GetPreloadCsp(nsIContentSecurityPolicy** aPreloadCSP) override;
  NS_IMETHOD EnsurePreloadCSP(nsIDOMDocument* aDocument, nsIContentSecurityPolicy** aPreloadCSP) override;
  ...
  NS_IMETHOD GetOriginSuffix(nsACString& aOriginAttributes) final;
