...
function CheckLockState() {
  ...
  let sYes = Strings.GetStringFromName("developermode_checkyes");
  let sNo = Strings.GetStringFromName("developermode_checkno");
  let sUnknown = Strings.GetStringFromName("developermode_checkunknown");
  let sNotUSB = Strings.GetStringFromName("developermode_notUSBDevice");
