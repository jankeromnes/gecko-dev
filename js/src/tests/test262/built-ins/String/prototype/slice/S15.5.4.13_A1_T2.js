...
if (__instance.slice(function() {
  ...
  $ERROR('#1: var x; __instance = new Boolean; __instance.slice = String.prototype.slice;  __instance.slice(function(){return true;}(),x) === "else". Actual: ' + __instance.slice(function() {
    return true;
  }(), x));
}
//
