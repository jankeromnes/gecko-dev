...
/*---
description: Extension is observed when creation of variable binding would not produce an early error (try statement) (Function declaration in the `default` clause of a `switch` statement in the global scope)
