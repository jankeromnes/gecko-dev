...
/*---
description: Variable binding value is updated following evaluation (Function declaration in the `default` clause of a `switch` statement in the global scope)
