...
/*---
description: Variable binding is initialized to `undefined` in outer scope (Function declaration in the `default` clause of a `switch` statement in the global scope)
