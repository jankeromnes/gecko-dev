...
/*---
description: Extension not observed when there is a default parameter with the same name (Function declaration in the `default` clause of a `switch` statement in function scope)
