...
public:
  ...
  explicit EntityToUnicodeEntry(const char* aKey) : PLDHashEntryHdr() { mNode = nullptr; }
  EntityToUnicodeEntry(const EntityToUnicodeEntry& aEntry) : PLDHashEntryHdr() { mNode = aEntry.mNode; }
