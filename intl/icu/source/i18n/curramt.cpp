...
CurrencyAmount::CurrencyAmount(const Formattable& amount, const ConstChar16Ptr& isoCode,
                               UErrorCode& ec) :
    Measure(amount, new CurrencyUnit(isoCode, ec), ec) {
}

CurrencyAmount::CurrencyAmount(double amount, const ConstChar16Ptr& isoCode,
                               UErrorCode& ec) :
