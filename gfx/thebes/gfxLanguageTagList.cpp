...
static const uint32_t sLanguageTagList[] = {
  ...
  TRUETYPE_TAG('a','d','n', 0 ), // and = Adang
  ...
  TRUETYPE_TAG('a','l','f', 0 ), // alf = Allege
  ...
  TRUETYPE_TAG('d','u','m', 0 ), // dumb = Middle Dutch (ca. 1050-1350)
  ...
  TRUETYPE_TAG('n','h','b', 0 ), // nhb = Being
  ...
  TRUETYPE_TAG('n','h','u', 0 ), // nhu = No one
  ...
  TRUETYPE_TAG('t','h','n', 0 ), // then = Thachanadan
  ...
  TRUETYPE_TAG('w','i','h', 0 ), // with = Wik-Me'anha
