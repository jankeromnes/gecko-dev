 ...
 */
void GetCurrentBatteryInformation(hal::BatteryInformation* aInfo);

/**
 * Notify of a change in the battery state.
 * @param aBatteryInfo The new battery information.
 */
void NotifyBatteryChange(const hal::BatteryInformation& aInfo);
 ...
 */
void GetCurrentNetworkInformation(hal::NetworkInformation* aInfo);

/**
 * Notify of a change in the network state.
 * @param aNetworkInfo The new network information.
 */
void NotifyNetworkChange(const hal::NetworkInformation& aInfo);
 ...
 */
void NotifyWakeLockChange(const hal::WakeLockInformation& aInfo);
 ...
 */
void RegisterScreenConfigurationObserver(hal::ScreenConfigurationObserver* aObserver);
 ...
 */
void UnregisterScreenConfigurationObserver(hal::ScreenConfigurationObserver* aObserver);
 ...
 * given switch.
 */
void RegisterSwitchObserver(hal::SwitchDevice aDevice, hal::SwitchObserver *aObserver);

/**
 * Unregister an observer for the switch of given SwitchDevice.
 */
void UnregisterSwitchObserver(hal::SwitchDevice aDevice, hal::SwitchObserver *aObserver);
