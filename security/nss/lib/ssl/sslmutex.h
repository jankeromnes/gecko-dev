...
extern SECStatus sslMutex_Init(sslMutex *pMutex, int shared);
...
extern SECStatus sslMutex_Destroy(sslMutex *pMutex, PRBool processLocal);

extern SECStatus sslMutex_Unlock(sslMutex *pMutex);

extern SECStatus sslMutex_Lock(sslMutex *pMutex);
