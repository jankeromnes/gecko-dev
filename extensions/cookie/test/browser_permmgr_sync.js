...
add_task(async function() {
  ...
  // important, because we wanto to assert information about the initial state
  ...
  // NOTE: This permission is a preload permission, so it should be available in the content process from startup.
