...
function run_test() {
  ...
  caches.open('xpcshell-test').then(function(c) {
    ...
    responseList.forEach(function(response) {
      ...
      // response.url is a empty string in current test file. It should test for
      ...
      // response.redirected may be changed once test file is updated. It should
      // be false since current response.url is a empty string.
